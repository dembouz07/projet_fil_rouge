...
# Subnets publics (pour ALB, NAT Gateway, EC2 public)
...
# Subnets privés (pour EKS nodes, RDS, etc.)
...
# Association route tables - subnets privés
...
# Security Group pour instances publiques
